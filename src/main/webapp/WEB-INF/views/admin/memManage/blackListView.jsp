...
<div id="wrapper">
	...
	<div class="s-content__header col-full">
		<form name = "updateForm" action="<c:url value = '/admin/blackListUpdate.do'/>" method="post">
		...
		<table>
			...
			<tr>				
				<th>회원상태</th>
				<td>
				<select id="stateControll" class="form-control" name = "selectState" contextmenu="${member.mem_state }">
			...
			<tr>
				<td colspan="2">
					<input type="button" value="저장" onclick="updateFunc()"/>
