 ...
 */
@Repository
public interface ITPdsDAO {
	/**
	 * 파일 등록(메타데이터만..)
	 * @param pds
	 * @return row count
	 */
	public int insertPds(Travel_Tip_FileVO pds);
	 ...
	 * @return
	 */
	public int insertPdsList(Travel_TipVO travel);
	 ...
	 */
	public Travel_Tip_FileVO selectPds(long travel_file_no);
	 ...
	 * @return
	 */
	public int deletePdses(Travel_TipVO travel);
}
